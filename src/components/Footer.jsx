      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <ul className="space-y-3">
              {navLinks.map(({ name, link }) => (
                <li key={name}>
                  ...
                  >
                    <span className="w-0 group-hover:w-2 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-600 transition-all duration-300 mr-0 group-hover:mr-2"></span>
                    {name}
                  </a>
                </li>
              ))}
            ...
            <ul className="space-y-2">
              {resources.slice(0, 4).map((resource) => (
                <li key={resource}>
                  ...
                  >
                    <span className="w-0 group-hover:w-1.5 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-600 transition-all duration-300 mr-0 group-hover:mr-2"></span>
                    {resource}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-16 pt-8 border-t border-purple-500/20">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">Get the latest web design trends and tips delivered to your inbox.</p>
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-white/5 backdrop-blur-sm border border-purple-500/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400/50 focus:ring-1 focus:ring-cyan-400/50 transition-all duration-300"
              />
              <button className="px-6 py-3 bg-gradient-to-r from-cyan-400 to-purple-600 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300">
                Subscribe
              </button>
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 border-t border-purple-500/20 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">© 2024 Reakt Web Design. All rights reserved.</div>
