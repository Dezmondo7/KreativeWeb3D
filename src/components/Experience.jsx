      ...
      <section id="about" className="w-full section-padding xl:px-0">
        <div className="w-full h-full md:px-20 px-5">
          <div className="text-center max-w-2xl mx-auto">
            <h2
              className="mt-20 md:mt-30 lg:mt-40 text-5xl md:text-5xl font-extrabold mb-1 leading-[1.2] bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(168,85,247,0.4)] tracking-wide"
            >
              Reakt Web Design
            </h2>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="expText flex xl:gap-20 md:gap-10 gap-5 relative z-20">
                        ...
                        <div>
                          ...
                          <ul className="list-disc ms-5 mt-5 flex flex-col gap-4 text-gray-4200 text-base leading-relaxed max-width-800px">
